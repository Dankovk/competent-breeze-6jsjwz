import { PointerInfoPre, PointerInfo, PointerEventTypes } from "@babylonjs/core/Events/pointerEvents.js";
...
import { Vector2, Matrix } from "@babylonjs/core/Maths/math.vector.js";

import { ActionEvent } from "@babylonjs/core/Actions/actionEvent.js";
import { KeyboardEventTypes, KeyboardInfoPre, KeyboardInfo } from "@babylonjs/core/Events/keyboardEvents.js";
import { DeviceType, PointerInput } from "@babylonjs/core/DeviceInput/InputDevices/deviceEnums.js";
...
export class InputManager {
    ...
    _updatePointerPosition(evt) {
        ...
        if(!store.isRear) {
            this._pointerX = canvasRect.right - evt.clientX;
        } else {
